...
TEST_CASE("sequence")
{
  ...
  yk::asteroid::sequence_parser const seq{left, right};
...
TEST_CASE("chained sequence")
{
  ...
  yk::asteroid::sequence_parser const seq0{parser0, parser1};
  yk::asteroid::sequence_parser const seq1{parser2, parser3};
  yk::asteroid::sequence_parser const seq{seq0, seq1};
